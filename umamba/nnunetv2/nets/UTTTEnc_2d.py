...
class TTTLayer(nn.Module):
    def __init__(self, dim, layer_idx, d_state = 16, channel_token = False):
        ...
        # )
        self.TTTConfig = TTTConfig(hidden_size=dim, num_attention_heads=8, num_hidden_layers=d_state)
        self.TTTLinear = TTTLinear(self.TTTConfig, layer_idx)
...
class ResidualTTTEncoder(nn.Module):
    def __init__(self,
...
class UTTTEnc(nn.Module):
    def __init__(self,
        ...
        self.encoder = ResidualTTTEncoder(
            input_size,
            input_channels,
            n_stages,
            features_per_stage,
...
def get_uTTT_enc_2d_from_plans(
    ...
    segmentation_network_class_name = 'UTTTEnc'
    network_class = UTTTEnc
    kwargs = {
        'UTTTEnc': {
